        ...
        "navigation": [
            {
                ...
                "items": [
                    ...
                    },
                    {
                        "title": _("Farmers"),
                        "icon": "people",
                        "link": reverse_lazy("admin:system_farmer_changelist"),
                    },
                    {
                        "title": _("Farmer Inspection"),
                        "icon": "people",
                        "link": reverse_lazy("admin:system_farmerinspection_changelist"),
                    },
                    {
                        "title": _("Users"),
                        "icon": "people",
            ...
            "items": [
                {
                    ...
                    "link": reverse_lazy("admin:conf_district_changelist"),
